...
int main()
{
    ...
    system("cls");
    cout << "Uzduotis: ADS Nr.4, 4 variantas" << endl;
	cout << "Studentas - Vadim Ceremisinov, 4 grupe, 1 pogrupis." << endl;
	cout << "Programos salyga - Duotas keliu sarasas: miestas, miestas, kelio savininkas ir kaina. " << endl;
	cout << "Rasti pigiausia keliones is vieno duoto miesto i kita duota miesta marsruta ir jo kaina. " << endl;
	cout << "Kaina sudaro tik vaziavimo keliu kaina, be to, savininkas duoda 50 % nuolaida, jei atvaziuota jam priklausanciu keliu." << endl;
	cout << "Numatyti atveji, kad toks marsrutas neegzistuoja. (Grafo realizacija grindziama kaimynystes sarasais.)" << endl;


    file << "PIRMA DALIS. Duomenys" << endl << endl;
	file << " 1) Uzduotis: ADS Nr.4, 4 variantas" << endl;
    file << " 2) Studentas - Vadim Ceremisinov, 4 grupe, 1 pogrupis." << endl;
    file << " 3) Programos salyga - Duotas keliu sarasas: miestas, miestas, kelio savininkas ir kaina. " << endl;
	file << "    Rasti pigiausia keliones is vieno duoto miesto i kita duota miesta marsruta ir jo kaina. " << endl;  
	file << "    Kaina sudaro tik vaziavimo keliu kaina, be to, savininkas duoda 50 % nuolaida. " << endl;
	file << "    Jei atvaziuota jam priklausanciu keliu." << endl;
	file << "    Numatyti atveji, kad toks marsrutas neegzistuoja. (Grafo realizacija grindziama kaiminystes sarasais.)" << endl;
